...
- **Framework:** Flutter
- **Language:** Dart
- **State Management:** *(Update with your choice, e.g., Riverpod, Provider, Bloc, GetX)*
- **Database:** *(Update with your choice, e.g., Hive, SQLite, Isar, Firebase)*
- **Architecture:** Clean Architecture *(if applicable)*
